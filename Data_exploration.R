data_exploration <- function(dataset) {
  ...
  # Last 15 features
  png("Plots/Data_exploration/density_plots_pt2.png",
      width=958,
      height=1008)
  ...
  png("Plots/Data_exploration/density_plots_tot_pt1.png",
      width=958,
      height=1008)
  ...
  png("Plots/Data_exploration/density_plots_tot_pt2.png",
      width=958,
      height=1008)
  ...
  for(i in 1:30) {
    ...
    sw <- rbind(sw,
                c(round(test$statistic,digits=5),
                  round(test$p.value,digits=5)))
  }
  ...
  corrplot(correlations,
           ...
           tl.col="black")
  t <- 0.81
  corr.var <- findCorrelation(correlations,
                              cutoff=t,
                              verbose=TRUE,
                              exact=TRUE,
                              names=TRUE)
